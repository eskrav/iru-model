...
## Wonky habitual: "John went shopping. He paid the cashier!"
...
```{r wonky noisy hRSA plots 1, fig.height = 2, echo=FALSE}
...
```{r wonky noisy hRSA plots 2, fig.height = 2, echo=FALSE}
...
## Ordinary non-habitual: "John went shopping. He got some apples!"
...
```{r ordinary nonhab noisy hRSA plots 1, fig.height = 2, echo=FALSE}
results(l0_95,"Literal Listener: \"(...)\", 95% Habitual Activity", states)
results(l0_50,"Literal Listener: \"(...)\", 50% Habitual Activity", states)
results(l0_5,"Literal Listener: \"(...)\", 5% Habitual Activity", states)
```
...
```{r ordinary nonhab noisy hRSA plots 2, fig.height = 2, echo=FALSE}
results(s_95,"Speaker: Activity Happened, 95% Habitual Activity", utterances)
results(s_50,"Speaker: Activity Happened, 50% Habitual Activity", utterances)
results(s_5,"Speaker: Activity Happened, 5% Habitual Activity", utterances)
```
...
## Wonky non-habitual: "John went shopping. He got some apples!"
...
```{r wonky nonhab noisy hRSA plots 1, fig.height = 2, echo=FALSE}
results(l0_95,"Literal Listener: \"(...)\", 95% Habitual Activity", states)
results(l0_50,"Literal Listener: \"(...)\", 50% Habitual Activity", states)
results(l0_5,"Literal Listener: \"(...)\", 5% Habitual Activity", states)
```
...
```{r wonky nonhab noisy hRSA plots 2, fig.height = 2, echo=FALSE}
results(s_95,"Speaker: Activity Happened, 95% Habitual Activity", utterances)
results(s_50,"Speaker: Activity Happened, 50% Habitual Activity", utterances)
results(s_5,"Speaker: Activity Happened, 5% Habitual Activity", utterances)
```
